...
Engineering Student - Computer Networks Mini Project

---

**Note**: This is a simulation dashboard for educational purposes. It does not connect to actual network hardware.
